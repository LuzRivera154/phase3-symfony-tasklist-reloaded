 ...
 */
final class Version20260420113431 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__priority AS SELECT id, level FROM priority');
        $this->addSql('DROP TABLE priority');
        $this->addSql('CREATE TABLE priority (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO priority (id, name) SELECT id, level FROM __temp__priority');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO priority (id, level) SELECT id, name FROM __temp__priority');
        $this->addSql('DROP TABLE __temp__priority');
